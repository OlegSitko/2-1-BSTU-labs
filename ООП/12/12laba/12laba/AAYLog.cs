...
namespace _12laba
{
    public class AAYLog
    {
        ...
        public void WriteFile(string action, string path= @"C:\Users\Avdey\OneDrive\Рабочий стол\ООП\12\12laba\12laba\bin\Debug\netcoreapp3.1\log.txt", string fileName = "log.txt")
        {
